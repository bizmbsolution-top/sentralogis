...
const ClearanceHero: React.FC<ClearanceHeroProps> = ({ title }) => {
    ...
    return (
        <div className="relative mb-8 overflow-hidden rounded-[3rem] bg-[#0f172a] border border-slate-800 shadow-2xl group/banner">
            <div className="absolute inset-0 bg-gradient-to-br from-blue-600/30 via-transparent to-transparent z-0" />
            <div className="absolute -top-24 -right-24 w-96 h-96 bg-blue-500/10 rounded-full blur-[120px] pointer-events-none" />
            <div className="absolute -bottom-24 -left-24 w-72 h-72 bg-emerald-500/10 rounded-full blur-[100px] pointer-events-none" />
                    ...
                    <div className="text-center md:text-left space-y-2">
                        <div className="flex items-center gap-4 mb-4 justify-center md:justify-start">
                            <div className="px-3 py-1 bg-white/5 border border-white/10 rounded-full flex items-center gap-2">
                                ...
                                <span className="text-[9px] font-black text-white/50 uppercase tracking-[0.3em]">Operational Cockpit v3.1</span>
                            </div>
                        </div>
                        <h1 className="text-3xl md:text-4xl font-black text-white tracking-tighter uppercase italic leading-none mb-2">
                            {title || (
                                <>
                                    Regulatory Fortress,<br/>
                                    <span className="text-blue-400">Compliance Mastery</span>
                                </>
                            )}
                        </h1>
                    </div>
