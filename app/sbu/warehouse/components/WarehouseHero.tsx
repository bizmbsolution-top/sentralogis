...
export default function WarehouseHero({ title }: WarehouseHeroProps) {
    ...
    return (
        <div className="relative overflow-hidden rounded-[3rem] bg-slate-900 border border-slate-800 shadow-2xl group/banner">
            <div className="absolute inset-0 bg-gradient-to-br from-orange-500/20 via-transparent to-transparent z-0" />
            <div className="absolute -top-24 -right-24 w-96 h-96 bg-orange-500/10 rounded-full blur-[120px] pointer-events-none" />
            <div className="absolute -bottom-24 -left-24 w-72 h-72 bg-slate-500/10 rounded-full blur-[100px] pointer-events-none" />
            ...
            <div className="relative z-10 px-8 py-6 md:px-16 md:py-8 flex flex-col md:flex-row items-center justify-between gap-12">
                <div className="flex flex-col md:flex-row items-center gap-10">
                    ...
                    <div className="text-center md:text-left space-y-2">
                        ...
                        <h1 className="text-3xl md:text-4xl font-black text-white tracking-tighter uppercase italic leading-none mb-2">
                            {title || (
                                <>
                                    Inventory Mission,<br/>
                                    <span className="text-orange-500 font-black">Strategic Control</span>
                                </>
                            )}
                        </h1>
                    </div>
                ...
                <div className="flex flex-col items-center md:items-end gap-1 bg-white/5 backdrop-blur-md border border-white/10 p-5 rounded-[2rem] shadow-2xl">
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <span className="text-[10px] font-black text-orange-500 uppercase tracking-[0.4em] italic leading-none">Live Ops Node</span>
                    </div>
