...
export default function TenantProfilePage() {
  ...
  const [tenantName, setTenantName] = useState('Assigned Tenant');
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-10 animate-slide-up">
      ...
      <div>
        <h1 className="text-3xl font-bold text-slate-900 tracking-tight mb-1">Profile</h1>
        <p className="text-sm font-medium text-slate-500">Manage your account identity and connection settings.</p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
        <div className="md:col-span-1 space-y-4">
           <h3 className="text-sm font-bold text-slate-900 uppercase tracking-widest">Identity</h3>
            ...
            <CardContent className="space-y-6">
              <div className="p-6 bg-blue-50/50 border border-blue-100 rounded-xl flex items-center justify-between gap-6">
                 <div className="flex items-center gap-4">
                   ...
                   <div>
                       <p className="text-[10px] font-black text-blue-400 uppercase tracking-widest mb-1">Current Tenant</p>
