...
import { 
    Building2, MapPin, Mail, User, Phone, Save, 
    Upload, X, Loader2, Image as ImageIcon, ChevronLeft,
            ...
            <div className="max-w-6xl mx-auto space-y-12">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
                    <div className="space-y-4">
                        <Link href="/admin" className="inline-flex items-center gap-3 text-slate-500 hover:text-blue-400 transition-all group">
                            <ChevronLeft className="w-5 h-5 group-hover:-translate-x-1 transition-transform" />
                            <span className="text-[10px] font-black uppercase tracking-[0.3em]">Back to Command Center</span>
                        </Link>
                        <div className="space-y-2">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <p className="text-[10px] font-black uppercase tracking-[0.4em] text-slate-500 italic">Terminal 01: Branding & Profile Management</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-6 bg-white/5 backdrop-blur-md border border-white/10 p-6 rounded-[2.5rem] shadow-2xl">
                         <div className="text-right">
                             <p className="text-[11px] font-black uppercase tracking-widest text-slate-500">System Principal</p>
                             <p className="text-base font-black italic text-white uppercase tracking-tight">{userProfile?.full_name}</p>
                         </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                    ...
                    <div className="lg:col-span-4 space-y-8">
                        <div className="bg-[#111214] border border-white/5 rounded-[3.5rem] p-10 relative overflow-hidden group shadow-2xl">
                            ...
                            <h3 className="text-[13px] font-black uppercase tracking-[0.3em] text-slate-400 mb-10 italic">Core Branding Asset</h3>
                                ...
                                {formData.logo_url ? (
                                    ...
                                    <label className="cursor-pointer flex flex-col items-center gap-4">
                                        <div className="w-20 h-20 bg-white/5 rounded-3xl flex items-center justify-center group-hover/logo:bg-blue-600/20 transition-all">
                                            {uploading ? <Loader2 className="w-10 h-10 text-blue-500 animate-spin" /> : <Upload className="w-10 h-10 text-slate-500 group-hover/logo:text-blue-500 transition-all" />}
                                        </div>
                                        <span className="text-[10px] font-black uppercase tracking-widest text-slate-500 group-hover/logo:text-blue-500 transition-all">Deploy Corporate Logo</span>
                            ...
                            <div className="mt-10 p-6 bg-white/5 rounded-3xl border border-white/5">
                                <p className="text-[9px] font-black text-slate-500 uppercase tracking-widest leading-loose">
                                    Logo ini akan otomatis disematkan pada seluruh dokumen dinamis (Surat Jalan, Invoicing, Laporan) di setiap unit bisnis SBU. Gunakan format .PNG transparan untuk hasil premium.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="bg-gradient-to-br from-blue-600/10 to-indigo-600/10 p-8 rounded-[2.5rem] border border-blue-500/10 shadow-xl">
                            <div className="flex items-center gap-4 mb-6">
                                ...
                                <h4 className="text-[13px] font-black uppercase tracking-widest">System Status</h4>
                            </div>
                            <div className="space-y-4">
                                ...
                                <p className="text-[10px] text-slate-500 italic">Identity updates propagate globally across all SBU nodes in real-time.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="lg:col-span-8">
                        <form onSubmit={handleSave} className="bg-[#111214] border border-white/5 rounded-[3.5rem] p-10 md:p-14 space-y-12 shadow-2xl relative overflow-hidden">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                                <div className="space-y-4">
                                    <label className="text-[11px] font-black uppercase tracking-[0.3em] text-slate-500 ml-4 italic flex items-center gap-3">
                                        <Building2 className="w-4 h-4 text-blue-500" /> Corporate Name
                                    </label>
                                    <input 
                                        type="text" 
                                        required
                                ...
                                <div className="space-y-4">
                                    <label className="text-[11px] font-black uppercase tracking-[0.3em] text-slate-500 ml-4 italic flex items-center gap-3">
                                        <Mail className="w-4 h-4 text-blue-500" /> Institutional Email
                                    </label>
                                    <input 
                                        type="email" 
                                        required
                            ...
                            <div className="space-y-4">
                                <label className="text-[11px] font-black uppercase tracking-[0.3em] text-slate-500 ml-4 italic flex items-center gap-3">
                                    <MapPin className="w-4 h-4 text-blue-500" /> Headquarters Terminal Address
                                </label>
                                <textarea 
                                    required
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                                ...
                                <div className="space-y-4">
                                    <label className="text-[11px] font-black uppercase tracking-[0.3em] text-slate-500 ml-4 italic flex items-center gap-3">
                                        <Phone className="w-4 h-4 text-blue-500" /> Secure Contact Line
                                    </label>
                                    <input 
                                        type="text" 
                                        required
                                        value={formData.pic_phone}
                                        onChange={(e) => setFormData(p => ({ ...p, pic_phone: e.target.value }))}
                                        placeholder="+62 8..."
                                        className="w-full bg-white/5 border border-white/10 rounded-3xl py-6 px-10 text-base font-black italic text-white placeholder:text-slate-700 focus:outline-none focus:border-blue-500/50 focus:bg-white/10 transition-all shadow-inner outline-none" 
                                    />
                                </div>
