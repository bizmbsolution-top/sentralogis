...
import { ChevronLeft, Users, AlertCircle, TrendingUp, DollarSign } from "lucide-react";
    ...
    <div className="min-h-screen bg-[#F8FAFC] p-8">
      ...
      <div className="max-w-[1600px] mx-auto">
        <header className="mb-8">
          <h1 className="text-2xl font-bold text-slate-900">Profitabilitas Pelanggan</h1>
          <p className="text-slate-500 text-sm mt-1">LTV, CAC, margin per customer, share of wallet, churn risk</p>
        </header>
        <div className="bg-white border border-slate-200 rounded-2xl p-8 text-center">
          ...
          <ul className="text-sm text-slate-600 list-disc list-inside space-y-2 text-left max-w-md mx-auto">
            ...
            <li>Customer Acquisition Cost (CAC) tracking</li>
            <li>Margin per customer & per project</li>
            <li>Share of wallet analysis</li>
            <li>Churn risk scoring</li>
            <li>Top 20% customers driving 80% revenue</li>
          </ul>
        </div>
      </div>
    </div>
