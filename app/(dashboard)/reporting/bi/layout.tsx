...
export default function BILayout({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC]">
      <ReportingNav activeCategory="bi" activeReport={activeReport} userRole={profile?.role} />
      <ReportingNavMobile activeCategory="bi" activeReport={activeReport} userRole={profile?.role} />
