...
import { ChevronLeft, Truck, AlertCircle, DollarSign, TrendingUp } from "lucide-react";
    ...
    return (
      <div className="flex items-center justify-center min-h-[60vh]">
        <div className="bg-white border border-slate-200 rounded-2xl p-10 shadow-sm text-center max-w-md">
          ...
          <p className="text-xs text-slate-500">Hanya Owner/Director Ops/SBU Trucking yang dapat mengakses.</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-[#F8FAFC] p-8">
      ...
      <div className="max-w-[1600px] mx-auto">
        <header className="mb-8">
          <h1 className="text-2xl font-bold text-slate-900">Fleet & Asset ROI</h1>
          <p className="text-slate-500 text-sm mt-1">Revenue per asset, utilization %, maintenance cost, replacement timing</p>
        </header>
        <div className="bg-white border border-slate-200 rounded-2xl p-8 text-center">
          ...
          <ul className="text-sm text-slate-600 list-disc list-inside space-y-2 text-left max-w-md mx-auto">
            <li>Revenue per truck/asset per month</li>
            <li>Utilization % (working days / total days)</li>
            <li>Maintenance cost trend per asset</li>
            <li>Fuel efficiency tracking</li>
            <li>Asset replacement recommendation (age, cost, revenue)</li>
            <li>ROI per fleet investment</li>
          </ul>
        </div>
      </div>
    </div>
