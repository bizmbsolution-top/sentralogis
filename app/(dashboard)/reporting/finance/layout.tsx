...
export default function FinanceLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC]">
      <ReportingNav activeCategory="finance" activeReport={activeReport} userRole={profile?.role} />
      <ReportingNavMobile activeCategory="finance" activeReport={activeReport} userRole={profile?.role} />
