  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] flex flex-col items-center justify-center p-8">
      ...
      <div className="bg-white border border-slate-200 rounded-3xl p-12 max-w-2xl text-center shadow-sm">
        ...
        <h1 className="text-2xl font-bold text-slate-900 mb-2">Margin Waterfall</h1>
        <p className="text-slate-500 mb-8">Revenue → Direct Cost → Overhead → Net Margin by customer/route/SBU.</p>
        <div className="bg-rose-50 border border-rose-200 rounded-xl p-4 text-left">
          <p className="text-sm font-semibold text-rose-800 mb-2">🚧 Coming Soon (Phase 3)</p>
          <p className="text-xs text-rose-700">Fitur akan mencakup:</p>
          <ul className="text-xs text-rose-700 list-disc list-inside space-y-1 mt-2">
            <li>Waterfall chart per customer/route</li>
            <li>Direct cost breakdown (fuel, toll, driver, vendor)</li>
            <li>Overhead allocation methodology</li>
            <li>Net margin % per segment</li>
          </ul>
        </div>
      </div>
    </div>
