-- ============================================================================
-- SENTRALOGIS DATA-4E-R10 FINAL FORENSIC REPAIR
-- STATUS: NOT AUTHORIZED FOR EXECUTION
-- DO NOT DEPLOY
-- Architecture: ADR-075 fw_locations Migration
-- ============================================================================
-- R10 REPAIR OBJECTIVES:
-- R10-01: True Idempotency (second-run NO-OP)
-- R10-02: FK Constraint State Machine (explicit classification)
-- R10-03: FK Value State Machine (explicit classification)
-- R10-04: BOTH + CONFLICT protection (NULL-safe semantic comparison)
-- R10-05: Transaction Atomicity (documented)
-- R10-06: FK Catalog Verification (exact metadata)
-- R10-07: ON DELETE/ON UPDATE Equivalence (preserve RESTRICT/NO ACTION)
-- R10-08: Rollback Boundary (transaction-only, honest)
-- R10-09: Canonical Provenance (transaction-local)
-- R10-10: Tenant Safety (4/4 tenant-scoped transformations)
--
-- CRITICAL ORDER:
