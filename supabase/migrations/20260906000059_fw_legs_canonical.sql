-- ============================================================================
-- Migration: 20260906_059_fw_legs_canonical.sql
-- Description: SBU Forwarding Domestik — Create fw_legs with canonical schema
--              aligned to existing migration intent and live schema state.
-- ============================================================================
...
CREATE TABLE public.fw_legs (
  ...
  order_id UUID NOT NULL REFERENCES public.fw_order_headers(id) ON DELETE CASCADE,
