-- Migration 20260817_driver_identity_rpc_security_repair.sql
-- Resumes the partially executed security migration.

BEGIN;

-- 1. Adopt existing unique index into a constraint to fix the 42P07 error
ALTER TABLE public.driver_profiles 
  ADD CONSTRAINT uq_driver_profiles_phone 
  UNIQUE USING INDEX uq_driver_profiles_phone;
