import { Emotion, AnimationState, PresenceMode } from '../SentraBotState';
import { EmotionProfile, EmotionProfiles } from './EmotionProfile';
...
export class EmotionEngine {
  ...
  static getProfile(emotion: Emotion): EmotionProfile {
    return EmotionProfiles[emotion] || EmotionProfiles[Emotion.NEUTRAL];
  }
}
